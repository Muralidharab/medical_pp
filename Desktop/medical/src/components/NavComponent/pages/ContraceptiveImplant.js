...
import '.././styles/ContraceptiveImplant.css'; // Create this CSS file for styling
...
function ContraceptiveImplant() {
  return (
    <div className="contraceptive-implant-container mt-3 ml-3">
      ...
      <h3>Key Features of Implanon</h3>
      <h4>1. Size and Appearance:</h4>
      <p>
      ...
      <h4>2. Insertion and Placement:</h4>
      <p>
      ...
      <h4>3. Hormonal Function:</h4>
      <ul>
        <li><strong>Suppress Ovulation:</strong> Prevents the ovaries from releasing eggs.</li>
        <li><strong>Thicken Cervical Mucus:</strong> Makes it difficult for sperm to enter the uterus.</li>
        <li><strong>Alter the Uterine Lining:</strong> Reduces the likelihood of implantation.</li>
      </ul>

      <h3>Benefits of Implanon</h3>
      <h4>1. Highly Effective:</h4>
      <p>
        Implanon is over 99% effective in preventing pregnancy, making it one of the most reliable contraceptive methods available.
      </p>
      <h4>2. Long-Lasting Protection:</h4>
      <p>
      ...
      <h4>1. Possible Side Effects:</h4>
      <ul>
        <li>Common side effects may include irregular bleeding, spotting, or changes in menstrual patterns.</li>
        <li>Some users may experience mood changes, headaches, or acne. Most side effects are mild and often resolve over time.</li>
      </ul>
      <h4>2. Eligibility and Consultation:</h4>
      <p>
...
export default ContraceptiveImplant;
